jQuery(function () {
    ...
    jQuery('#new_offer_section').on('click',"#new_offer_add_button",function(){
        var btn = jQuery(this);
        btn.prop("disabled","disabled");
        var name = start = end = banner = tag = offer_on = ids = discount_by = unit = discount_text = discount_text_p = "";
