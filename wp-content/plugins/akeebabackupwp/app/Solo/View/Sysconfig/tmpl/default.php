...
<form action="<?php echo $router->route('index.php?view=sysconfig') ?>" method="POST" id="adminForm" class="form-horizontal" role="form">
	...
	<div class="tab-content">
		<div id="sysconfigAppSetup" class="tab-pane active">
			...
			<div class="form-group">
				<label for="forced_backup_timezone" class="col-sm-2 control-label">
		...
		<div id="sysconfigPublicAPI" class="tab-pane">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" name="options[frontend_secret_word]" id="frontend_secret_word" placeholder="<?php echo Text::_('COM_AKEEBA_CONFIG_SECRETWORD_LABEL'); ?>" value="<?php echo \Akeeba\Engine\Platform::getInstance()->get_platform_configuration_option('frontend_secret_word', '') ?>">
					<div class="help-block">
