...
<script type="text/javascript" src="<?php echo Uri::base(); ?>media/js/selectize.min.js?<?php echo $this->container->mediaQueryKey ?>"></script>
<?php
...
<link rel="stylesheet" type="text/css" href="<?php echo Uri::base(); ?>/media/css/selectize/selectize.bootstrap3.css?<?php echo $this->container->mediaQueryKey ?>" />
