...
// Template scripts
	...
	-->
		...
		<script type="text/javascript"
				src="<?php echo Uri::base(); ?>media/js/selectize.min.js?<?php echo $mediaquery ?>"></script>
	<?php
	else:
	?>
		<!--
	...
	<link rel="stylesheet" type="text/css"
		  href="<?php echo Uri::base(); ?>/media/css/selectize/selectize.bootstrap3.css?<?php echo $mediaquery ?>"/>
