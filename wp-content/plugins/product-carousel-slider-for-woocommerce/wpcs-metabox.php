...
function meta_box_content_output( $post ) {
    ...
    $wpcs_display_product_desc = get_post_meta( $post->ID, 'wpcs_display_product_desc', true );
            ...
            <div id="tab-3" class="tab-content">
                ...
                <div class="cmb2-wrap form-table">
                    ...
                    <div id="cmb2-metabox" class="cmb2-metabox cmb-field-list">
                        ...
                        <div class="cmb-row cmb-type-radio">
                            <div class="cmb-th">
                                <label for="wpcs_display_product_desc"><?php _e('Display Product Description', 'woocommerce-product-carousel-slider'); ?></label>
                            </div>
                            <div class="cmb-td">
                                <ul class="cmb2-radio-list cmb2-list">  
                                    <li><input type="radio" class="cmb2-option" name="wpcs_display_product_desc" id="wpcs_display_product_desc1" value="yes" <?php if($wpcs_display_product_desc == "yes")  { echo "checked"; } else { echo "checked"; } ?>> <label for="wpcs_display_product_desc1"><?php _e('Yes', 'woocommerce-product-carousel-slider'); ?></label></li>
                                    <li><input type="radio" class="cmb2-option" name="wpcs_display_product_desc" id="wpcs_display_product_desc2" value="no" <?php if($wpcs_display_product_desc == "no") { echo "checked"; } else { echo ""; } ?>> <label for="wpcs_display_product_title2"><?php _e('No', 'woocommerce-product-carousel-slider'); ?></label></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
/*
    ...
    $wpcs_display_product_desc_value = "";
    ...
    if(isset($_POST["wpcs_display_product_desc"])){
        $wpcs_display_product_desc_value = sanitize_text_field( $_POST["wpcs_display_product_desc"] );
    }   

    update_post_meta($post_id, "wpcs_display_product_desc", $wpcs_display_product_desc_value);
