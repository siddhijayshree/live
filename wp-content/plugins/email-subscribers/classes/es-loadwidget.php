...
class es_cls_widget {
	public static function load_subscription($arr) {
		...
		$es .= '<div class="es_lablebox"><label class="es_shortcode_form_email">'.__( 'Get the latest deals & promotions: ', ES_TDOMAIN ).'</label></div>';
		$es .= '<div class="es_textbox">';
			$es .= '<input type="text" id="es_txt_email_pg" class="es_textbox_class" name="es_txt_email_pg" onkeypress="if(event.keyCode==13) es_submit_pages(event, '.$url.')" value="" maxlength="225" placeholder="Email Address">';
